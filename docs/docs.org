...
- Lista jednostek na danych węzłach
- Jednostka dostarczająca GPS o najniższej tolerancji błędu
- Dodanie nowej klasy i inferencja istniejących pojęć do niej pasujących
